...
\textsf{In this step you will need to download and create the appropriate boot media for Debian 6 (Squeeze).
...
\begin{list}{•}{•}
\item \textsf{Debian 32bit CD/DVD images:} \newline
\url{http://cdimage.debian.org/debian-cd/6.0.4/i386/iso-cd/}
\item \textsf{Debian 64bit CD/DVD images:} \newline
