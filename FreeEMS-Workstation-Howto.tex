\documentclass[12pt,notitlepage,onecolumn,oneside,draft]{memoir}
\usepackage{amsmath}
\textwidth=7.0in
\textheight=9.5in
\topmargin=0in
...
\begin{center}
\textbf{This document assumes you are starting with a blank hard drive.} \newline
\textbf{ie: NO OPERATING SYSTEM.} \newline
\newline
\textbf{Make sure you start with Step A and do not skip any steps.} \newline
\textbf{They are in this order for a reason!} \newline
\newline
\textbf{How to setup an Intel or AMD PC with 1 Tb HDD to Dual Boot Windows 7} \newline
\textbf{and either Debian 6 (Squeeze) or Ubuntu 11.10 (Oneiric Ocelot):} \newline
