...
\url{https://www.pemicro.com/login.cfm?from\_url=/downloads/download_file.cfm?download_id=16}
...
\item \textsf{Once you are done with all the Windows 7 updates and rebooting proceed to Step B on the next page.}
\end{enumerate}
